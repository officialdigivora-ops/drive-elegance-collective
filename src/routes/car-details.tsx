...
export const Route = createFileRoute("/car-details")({
  ...
  head: () => ({
    meta: [
      { title: "Car Details | Chaudhary Luxury Cars" },
      { name: "description", content: "Full specifications, photos and 13-hour rental pricing for every car in the Chaudhary Luxury Cars fleet." },
      { property: "og:title", content: "Car Details | Chaudhary Luxury Cars" },
      { property: "og:description", content: "Photos, specifications and 13-hour rental pricing with fuel and driver included." },
