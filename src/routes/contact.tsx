  ...
  head: () => ({
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        "@id": "https://drive-elegance-collective.lovable.app/contact#business",
        name: "Chaudhary Luxury Cars",
        description: "Luxury and wedding car rental in Panipat, Delhi NCR, Haryana and Uttar Pradesh. Book online and confirm on WhatsApp. 13-hour packages with fuel, driver, decoration and toll included.",
        url: "https://drive-elegance-collective.lovable.app/contact",
        ...
        hasMap: "https://www.google.com/maps/search/?api=1&query=92M8%2B62C%20Sanoli%20Rd%20Panipat%20Haryana%20132104",
        areaServed: ["Panipat", "Delhi", "Noida", "Gurugram", "Ghaziabad", "Faridabad", "Sonipat", "Karnal", "Meerut", "Agra", "NCR", "Haryana", "Uttar Pradesh"],
